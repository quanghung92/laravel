@extends('master.master')<!--Kế thừa code của file master-->

@section('title','quản lý thành viên') <!-- khi chèn 1 chuổi chỉ cần có tên của section và doạn chuỗi cần thêm -->


@section('content') <!-- Section  có tên content chứa đoạn mã Html riêng của từng trang sẽ được 'yield' gọi ra từ trang master -->
